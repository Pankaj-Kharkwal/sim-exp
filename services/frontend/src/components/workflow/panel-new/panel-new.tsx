...
import { useRegisterGlobalCommands } from '@/components/global-commands-provider'
import { useUserPermissionsContext } from '@/components/workspace-permissions-provider'
import { Variables } from '@/components/variables/variables'
import { useWorkflowExecution } from '@/hooks/use-workflow-execution'
import { useDeleteWorkflow } from '@/components/hooks'
...
export function Panel() {
  ...
  const handleDuplicateWorkflow = useCallback(async () => {
    ...
    try {
      ...
      if (newWorkflow) {
        navigate(`/workspace/${workspaceId}/w/${newWorkflow}`)
      }
    } catch (error) {
