...
import {
  ...
  UserInput,
  Welcome,
} from '@/components/copilot/components'
import type { MessageFileAttachment } from '@/components/user-input/hooks/use-file-attachments'
import type { UserInputRef } from '@/components/user-input/user-input'
import { useScrollManagement } from '@/components/hooks'
